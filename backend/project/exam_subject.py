...
bp = Blueprint('exam_subject', __name__, url_prefix='/exam_subject')
...
def getData():
    ...
    if column=="question_id" or column=="exam_id":
    ...
    try:
        ...
        if keyword.strip()=="":
            ...
            keyword = int(keyword)
            sql = 'select * from exam_subject where id = %s'
            sql_params = [keyword, ]
        elif column=="question_id":
            keyword = int(keyword)
            sql = 'select * from exam_subject where question_id = %s'
            sql_params = [keyword, ]
        elif column=="exam_id":
            keyword = int(keyword)
            sql = 'select * from exam_subject where exam_id = %s'
            sql_params = [keyword, ]
        else:
            sql = 'select * from exam_subject where %s'%column+" like %s"
            # %s对应的参数
            sql_params=['%'+keyword+'%',]
