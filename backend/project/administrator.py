...
def add():
    ...
    try:
        ...
        # sql语句
        sql = 'insert into `administrator`(username, password, create_time) VALUES (%s,%s,%s)'
        # %s对应的参数
...
def getData():
    ...
    try:
        ...
        if keyword.strip()=="":
            ...
            keyword = int(keyword)
            sql = 'select * from `administrator` where id = %s'
            sql_params = [keyword, ]
        else:
            sql = 'select * from `administrator` where %s'%column+" like %s"
            # %s对应的参数
            sql_params=['%'+keyword+'%',]
...
def edit():
    ...
    try:
        ...
        # sql语句
        sql = 'update `administrator` set username=%s,`password`=%s where id = %s'
        # %s对应的参数
...
def getUser():
    ...
    try:
        ...
        sql = 'select * from administrator where username=%s'
        params = [username, ]
...
def login():
    ...
    try:
        ...
        sql = 'select * from administrator where username=%s and password=%s'
